 ...
 *  least as wide as the longest string plus SPACE blanks.  Figure
 ...
 *
 *  HISTORY
 * 17-Apr-83  Rafael Bracho (rxb) at Carnegie-Mellon University
 *	Bug fixed: We were using \n instead of \r\n!! While I was at it,
 *	I modified it so it uses %-vs instead of doing an sprintf () to
 *	form the format string (we have variable width fields!)
 *
 ...
 */

#define SPACE 3			/* min. space between columns */
    ...
    char  **list;
{
    ...
    register int col;		/* current position */
    int row;
    register int ncol;		/* desired format */
    int nrow;
